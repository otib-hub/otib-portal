						...
						<div className="flex flex-col gap-4">
							<p className="text-base md:text-lg text-secondary-foreground space-y-2">
								<span className="font-semibold">
									{t(
										'section/what-happens-now.paragraphs.1.title',
									)}
								</span>
								<br />
								<span className="text-muted-foreground">
									{t(
										'section/what-happens-now.paragraphs.1.description',
									)}
								</span>
							</p>
							<p className="text-base md:text-lg text-secondary-foreground space-y-2">
								<span className="font-semibold">
									{t(
										'section/what-happens-now.paragraphs.2.title',
									)}
								</span>
								<br />
								<span className="text-muted-foreground">
									{t(
										'section/what-happens-now.paragraphs.2.description',
									)}
								</span>
							</p>
							<p className="text-base md:text-lg text-secondary-foreground space-y-2">
								<span className="font-semibold">
									{t(
										'section/what-happens-now.paragraphs.3.title',
									)}
								</span>
								<br />
								<span className="text-muted-foreground">
									{t(
										'section/what-happens-now.paragraphs.3.description',
									)}
								</span>
							</p>
						</div>

...
export function getTouristIndividualResearchFormSteps(
	t: TFunction<'forms'>
): Array<FormStep> {
	return [
		{
			number: 1,
			title: t('TouristIndividualResearchForm.steps.1.title'),
			step: TouristStep,
		...
		{
			number: 2,
			title: t('TouristIndividualResearchForm.steps.2.title'),
			step: PlanningStep,
		...
		{
			number: 3,
			title: t('TouristIndividualResearchForm.steps.3.title'),
			step: TripStep,
		...
		{
			number: 4,
			title: t('TouristIndividualResearchForm.steps.4.title'),
			step: ActivitiesStep,
		...
		{
			number: 5,
			title: t('TouristIndividualResearchForm.steps.5.title'),
			step: EvaluationStep,
